...
const Certification = ({ handleInputChange, handleDelete }) => {
    const [inputValue, setInputValue] = useState('');
    const [tags, setTags] = useState(['CET-4', 'PMP证书']);
