const Header = () => (
    <div>
        <div className="bg-accent-1 border-accent-2 border-b bg-slate-50">
          ...
          <span
              className="mr-2 hidden rounded bg-blue-100 px-2.5 py-0.5 text-xs font-semibold text-blue-800 dark:bg-blue-200 dark:text-blue-800 md:inline">
            新
        ...
        <header className="body-font text-gray-600">
            <div className="container mx-auto flex flex-col flex-wrap items-center p-5 md:flex-row">
                ...
                <nav className="flex flex-wrap items-center justify-center text-base md:ml-auto">
                    <a href="/"
                       className="mr-5 mt-4 rounded px-3 py-1 text-base hover:bg-sky-100 hover:text-gray-900 focus:outline-none md:mt-0 ">首页</a>
                    <div className="indicator">
                        <a href="/resume" className="mr-5 hover:text-gray-900">
                            <button
                                className="mt-4 inline-flex items-center rounded border-0 bg-gray-100 px-3 py-1 text-base hover:bg-gray-200 focus:outline-none md:mt-0">编辑简历
                                <img src="https://wickedblocks.dev/assets/images/logo.svg" alt=""
