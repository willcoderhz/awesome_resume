// reducers.ts
import { ADD_BASIC_INFO, UPDATE_BASIC_INFO, ADD_LINK, UPDATE_LINK, DELETE_LINK, REORDER_LINKS, ADD_WORK_EXPERIENCE, UPDATE_WORK_EXPERIENCE, DELETE_WORK_EXPERIENCE, REORDER_WORK_EXPERIENCE, ADD_SKILL, UPDATE_SKILL, DELETE_SKILL, REORDER_SKILLS, ADD_EDUCATION, UPDATE_EDUCATION, DELETE_EDUCATION, REORDER_EDUCATIONS, ADD_PERSONAL_PROJECT, UPDATE_PERSONAL_PROJECT, DELETE_PERSONAL_PROJECT, REORDER_PERSONAL_PROJECTS } from './actions'; // 从 actions.ts 导入 action 类型常量
...
function workExperiencesReducer(state = initialState.workExperiences, action) {
    switch (action.type) {
...
// Skills reducer
function skillsReducer(state = initialState.skills, action) {
    switch (action.type) {
        case ADD_SKILL:
            const newStateAdd = [...state, action.payload];
            return newStateAdd;
...
// Educations reducer
function educationsReducer(state = initialState.educations, action) {
    ...
    switch (action.type) {
        ...
        case UPDATE_EDUCATION:
            const newStateUpdate = state.map(education => education.key === action.payload.key ? { ...education, ...action.payload } : education);
...
function personalProjectsReducer(state = initialState.personalProjects, action) {
    switch (action.type) {
