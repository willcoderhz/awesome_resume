                                ...
                                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                                    ...
                                    <div className="mt-6 flex items-center">
                                        <div className="shrink-0">
                                            <a href="">
                                                <img className="h-10 w-10 rounded-full" src="~/assets/images/testimonial-1.png" alt="" />
                                            </a>
                                        </div>
                                        <div className="ml-3">
                            ...
                            <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                                    ...
                                    <div className="mt-6 flex items-center">
                                        <div className="shrink-0">
                                            <a href="#">
                                                <img className="h-10 w-10 rounded-full" src="~/assets/images/testimonial-2.png" alt="" />
                                            </a>
                                        </div>
                                        <div className="ml-3">
                                            <p className="text-sm font-medium text-neutral-600">
                            ...
                            <div className="flex flex-col overflow-hidden rounded-lg shadow-lg">
                                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                                    ...
                                    <div className="mt-6 flex items-center">
                                        <div className="shrink-0">
                                            <a href="#">
                                                <img className="h-10 w-10 rounded-full" src="~/assets/images/testimonial-3.png" alt="" />
                                            </a>
                                        </div>
                                        <div className="ml-3">
                                            <p className="text-sm font-medium text-neutral-600">
...
var _default = exports["default"] = Mainc;