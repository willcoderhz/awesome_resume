...
var SkillsInfo = function SkillsInfo() {
  ...
  (0, _react.useEffect)(function () {
    ...
    dataSource.forEach(function (data) {
      dispatch((0, _actions.addSkill)(data));
    });
        ...
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (index > -1) {
              ...
              setDataSource(newData);
              setEditingKey('');
              dispatch((0, _actions.updateSkill)(_objectSpread(_objectSpread({}, item), values)));
            }
            ;
          case 4:
          case "end":
  ...
  var handleDelete = function handleDelete(key) {
    ...
    dispatch((0, _actions.deleteSkill)(key));
  };
  var handleAdd = function handleAdd() {
    ...
    dispatch((0, _actions.addSkill)(newData));
  };
  var columns = [
  ...
  var onDragEnd = function onDragEnd(_ref4) {
    ...
    if (active.id !== (over === null || over === void 0 ? void 0 : over.id)) {
      setDataSource(function (previous) {
        ...
        var reordered = (0, _sortable.arrayMove)(previous, activeIndex, overIndex);

        // Dispatch the reorderSkills action
        dispatch((0, _actions.reorderSkills)(reordered));
        return reordered;
      });
    }
  };
  ...
  <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
    <_antd.Form.Item name="skillName" label="项目名称">
...
var _default = exports["default"] = SkillsInfo;