...
var ProjectsInfo = function ProjectsInfo() {
  ...
  (0, _react.useEffect)(function () {
    dataSource.forEach(function (data) {
      dispatch((0, _actions.addPersonalProject)(data));
    });
  }, []);
  ...
  var handleAdd = function handleAdd() {
    ...
    dispatch({
      ...
      payload: newData
    }); // Dispatch ADD action using newData
  };
  var columns = [
  ...
  <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
    <_antd.Form.Item name="projectName" label="项目名称">
  ...
  <_antd.DatePicker.RangePicker className="w-full" locale={_zh_CN["default"]} />
                ...
                <_antd.Form.Item name="description" label="详细描述">
...
var _default = exports["default"] = ProjectsInfo;