...
var Language = function Language(_ref) {
  ...
  var _useState3 = (0, _react.useState)(['熟练运用英文', '普通话母语']),
  ...
  return <div id="certification" className="bg-gray-00 p-2 ml-0 w-full">
      <div className="flex justify-between items-center mb-4">
        <_antd.Typography.Title level={3} className="ml-1">语言能力</_antd.Typography.Title>
    ...
    }} onBlur={handleInputConfirm} onPressEnter={handleInputConfirm} placeholder='请输入您掌握的语言，点击回车确认' />
    </div>;
};
