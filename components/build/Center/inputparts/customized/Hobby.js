...
var Hobby = function Hobby(_ref) {
  ...
  var _useState3 = (0, _react.useState)(['篮球', '弹钢琴']),
  ...
  return <div id="hobby" className="bg-gray-00 p-2 ml-0 w-full">
      <div className="flex justify-between items-center mb-4">
        <_antd.Typography.Title level={3} className="ml-1">个人爱好</_antd.Typography.Title>
    ...
    }} onBlur={handleInputConfirm} onPressEnter={handleInputConfirm} placeholder='请输入爱好，点击回车确认' />
    </div>;
};
var _default = exports["default"] = Hobby;