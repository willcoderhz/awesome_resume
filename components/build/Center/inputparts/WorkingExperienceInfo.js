...
var WorkingExperienceInfo = function WorkingExperienceInfo() {
  ...
  (0, _react.useEffect)(function () {
    ...
    dataSource.forEach(function (data) {
      dispatch((0, _actions.addWorkExperience)(data));
    });
  ...
  var save = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(key, values) {
      var newData, index, dateRange, restValues, payload;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            if (index > -1) {
              dateRange = values.dateRange, restValues = _objectWithoutProperties(values, _excluded); // 更新数据源
              newData.splice(index, 1, _objectSpread(_objectSpread(_objectSpread({}, newData[index]), restValues), {}, {
                dateRange: dateRange,
                // 直接使用 dateRange，无需转换
                isEditing: false,
                expand: false
              ...
              payload = _objectSpread(_objectSpread({}, restValues), {}, {
                dateRange: dateRange,
                id: key
              });
              console.log("Dispatching updateWorkExperience with payload:", payload);
              dispatch((0, _actions.updateWorkExperience)(payload));
            }
          case 3:
          case "end":
  ...
  var handleDelete = function handleDelete(key) {
    ...
    dispatch((0, _actions.deleteWorkExperience)(key));
  };
  var handleAdd = function handleAdd() {
    ...
    dispatch((0, _actions.addWorkExperience)(newData));
  };
  var columns = [
  ...
  var onDragEnd = function onDragEnd(_ref4) {
    ...
    if (active.id !== (over === null || over === void 0 ? void 0 : over.id)) {
      setDataSource(function (previous) {
        ...
        // 更新每个工作经历的 key
        var updatedOrder = newOrder.map(function (item, index) {
        ...
        dispatch((0, _actions.reorderWorkExperience)(updatedOrder));
        return updatedOrder;
      });
    }
  };
  ...
  <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
    <_antd.Form.Item name="companyName" label="公司名称">
      <_antd.Input className="w-full" />
    </_antd.Form.Item>
  </div>
  <div className="w-full md:w-1/2 px-3">
    <_antd.Form.Item name="jobTitle" label="工作岗位">
      <_antd.Input className="w-full" />
    </_antd.Form.Item>
  </div>
                </div>
                ...
                <div className="flex flex-wrap -mx-3">
  <div className="w-full md:w-1/2 px-3 mb-6 md:mb-0">
    <_antd.Form.Item name="city" label="所在城市">
      <_antd.Input className="w-full" />
    </_antd.Form.Item>
  </div>
  <div className="w-full md:w-1/2 px-3">
  ...
  <_antd.DatePicker.RangePicker className="w-full" locale={_zh_CN["default"]} />
                ...
                <_antd.Form.Item name="description" label="Description">
...
var _default = exports["default"] = WorkingExperienceInfo;